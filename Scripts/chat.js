            ...
            firebase.database().ref('fcmTokens').child(friend_id).once('value').then(function (data) {
                $.ajax({
                    ...
                    headers: {
                        ...
                        'Authorization': 'key=AAAAddR3MLU:APA91bFgAFMrwPWkV7AAwJsxABmjVG98IE1zvPmlyI10To-5LZNaZ06WX3vCPiOxRJLL4A6yYy2XNMWlKSneATBSdjIiMZ8DEuSDo72511XeKkusCHSYDws-dK9d1f4Vgcgc-684pdX6'
                    },
                    data: JSON.stringify({
